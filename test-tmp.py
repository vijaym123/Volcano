# https://electronics.stackexchange.com/a/154577
...
MOTOR_PWM.start(getDutyCycle(1.125, frequency))
sleep(3)

# try :
#     input_commands = {"forward": 1.3, "set_back" : 1.3, "break" : 1.5, "reverse": 1.4}
#     while True:
#        pulse_width = input_commands['forward']
#        while pulse_width<=1.50:
#            MOTOR_PWM.ChangeDutyCycle(7)#getDutyCycle(pulse_width, frequency))
